<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProvincialSuspensePayments.aspx.cs" Inherits="PaymentInquiry.ProvincialSuspensePayments" %>
    ...
    <asp:MultiView ID="ConsolidatedSuspensePaymentsMultiView" runat="server" ActiveViewIndex="0">
        <asp:View ID="ConsolidatedSuspensePaymentsView" runat="server">
            <table class="auto-style1">
                <tr>
                    <td colspan="4" align="left" style="font-family: Calibri; font-size: 16pt; font-weight: bold; color: #87181D;">Provincial Suspense Payments</td>
                </tr>
                <tr>
                    <td width="20%" colspan="4" style="font-family: Calibri; font-size: 12pt; font-weight: bold; color: #87181D;" class="auto-style1">&nbsp;</td>
                </tr>
                <tr>
                    <td width="20%" align="right" style="font-family: Calibri; font-size: 12pt; font-weight: bold; color: #87181D;">Province</td>
                    <td width="80%" colspan="3">
                        <asp:DropDownList ID="cmbProvince" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbProvince_SelectedIndexChanged"></asp:DropDownList></td>
                </tr>
                <tr>
                    <td width="20%" align="right" style="font-family: Calibri; font-size: 12pt; font-weight: bold; color: #87181D;">Area</td>
                    <td width="80%" colspan="3">
                        <asp:DropDownList ID="cmbArea" runat="server" Enabled="False"></asp:DropDownList></td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                         <asp:GridView ID="grdSearchDetails" runat="server" AutoGenerateColumns="False" Font-Names="Calibri" Font-Size="11pt" ForeColor="#87181D" Width="100%" AllowSorting="True" OnSorting="grdSearchDetails_Sorting" OnSelectedIndexChanged="grdSearchDetails_SelectedIndexChanged">
                            <Columns>
                                ...
                                <asp:BoundField DataField="susp_amount" HeaderText="Amount" DataFormatString="{0:N2}" SortExpression="susp_amount">
                                    <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <asp:BoundField DataField="trnsac_code" HeaderText="Transacton Code" SortExpression="trnsac_code">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                            </Columns>
