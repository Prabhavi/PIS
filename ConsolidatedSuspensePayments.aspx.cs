...
{
    public partial class ConsolidatedSuspensePayments : System.Web.UI.Page
    {
        ...
        protected void btnSearch__Click(object sender, ImageClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (selectedItem > 0)
                {
                    ...
                    DataSet dt = dbCon.GetSuspensePaymentsBillSmry(rqtS);
                    if (dt.Tables[0].Rows.Count != 0)
                    {
                        Session["SuspensePaymentsBillSmry"] = dt;
        ...
        protected void grdSearchDetails_Sorting(object sender, GridViewSortEventArgs e)
        {
            ...
            DataSet ds = (DataSet)Session["SuspensePaymentsBillSmry"];
            ...
            try
            {
                if (Session["UserName"] != null)
                {
                   ...
                   dtJnl.CounterNo = grdSearchDetails.SelectedRow.Cells[3].Text.Trim();
                    ...
                    dtJnl.bill_cycle = grdSearchDetails.SelectedRow.Cells[8].Text.Trim();
                    Session["DataToJournalConsolidated"] = dtJnl;
