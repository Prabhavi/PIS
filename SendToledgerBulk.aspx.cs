...
{
    public partial class SendToledgerBulk : System.Web.UI.Page
    {
            ...
            try
            {
              ...
              //  Response.Write(st);
                ...
                if (uLvl == "C")
                {
                    ...
                    {
                        this.Page.ClientScript.RegisterStartupScript(this.GetType(), "ex", "alert('you cant reject at this moment" + "');", true);                        //Load_grdSearchFromCorrectionBulk(dtJnl);
                    }
