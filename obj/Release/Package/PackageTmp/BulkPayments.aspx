<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BulkPayments.aspx.cs" Inherits="PaymentInquiry.BulkPayments" %>
    ...
    <asp:MultiView ID="BulkPaymentsMultiView" runat="server" ActiveViewIndex="0">
        <asp:View ID="BulkPaymentsView" runat="server">
            <table class="auto-style1">
                <tr>
                    <td colspan="4" align="left" style="font-family: Calibri; font-size: 16pt; font-weight: bold; color: #87181D;">Bulk Suspense Payments</td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                        <asp:GridView ID="grdSearchDetails" runat="server" AutoGenerateColumns="False" Font-Names="Calibri" Font-Size="11pt" ForeColor="#87181D" Width="100%" AllowSorting="True" OnSorting="grdSearchDetails_Sorting" OnSelectedIndexChanged="grdSearchDetails_SelectedIndexChanged" OnDataBound="grdSearchDetails_DataBound">
                            <Columns>
                                ...
                                <asp:BoundField DataField="paid_amt" HeaderText="Amount" SortExpression="paid_amt" DataFormatString="{0:C2}">
                                    <HeaderStyle HorizontalAlign="Left" />
                                ...
                                <asp:BoundField DataField="post_blcy" HeaderText="PostBillCycle" SortExpression="post_blcy">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="cleared" SortExpression="cleared">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("cleared") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
