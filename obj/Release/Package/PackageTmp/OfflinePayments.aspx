<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OfflinePayments.aspx.cs" Inherits="PaymentInquiry.OfflinePayments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:MultiView ID="OfflinePaymentsMultiView" runat="server" ActiveViewIndex="0">
        <asp:View ID="OfflinePaymentsView" runat="server">
            <table class="auto-style1">
                <tr>
                    <td colspan="4" align="left" style="font-family: Calibri; font-size: 16pt; font-weight: bold; color: #87181D;">Offline Payments</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td width="80%" colspan="3">
                        <asp:TextBox ID="txtAccountNo" runat="server" Width="121px"></asp:TextBox></td>
                </tr>
                <tr>
                    ...
                    <td colspan="4">
                        <asp:GridView ID="grdSearchDetails" runat="server" AutoGenerateColumns="False" Font-Names="Calibri" Font-Size="11pt" ForeColor="#87181D" Width="100%" AllowSorting="True" OnSorting="grdSearchDetails_Sorting" OnSelectedIndexChanged="grdSearchDetails_SelectedIndexChanged">
                            <Columns>
                                ...
                                <asp:BoundField DataField="trans_amt" HeaderText="Amount" DataFormatString="{0:C2}" SortExpression="trans_amt">
                                    <HeaderStyle HorizontalAlign="Left" />
