...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td width ="20%">
                <asp:TextBox ID="txtRefNo" runat="server" Visible="False"></asp:TextBox></td>
            <td width ="15%" align="right" style="font-family: Calibri; font-size: 12pt; font-weight: bold; color: #87181D;">Set off Account</td>
            <td>
                <asp:TextBox ID="txtAccountNo" runat="server" Visible="False"></asp:TextBox>
        ...
        <tr>
            ...
            <td width ="20%">
                <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Visible="False"></asp:TextBox></td>
            <td width ="15%" align="right" style="font-family: Calibri; font-size: 12pt; font-weight: bold; color: #87181D;">Journal No</td>
            <td>
                <asp:TextBox ID="txtJnlNo" runat="server" Visible="False"></asp:TextBox>
        ...
        <tr>
            ...
            <td width ="20%">
                <asp:DropDownList ID="cmbJourneleTy" runat="server" Visible="False">
            ...
            <td>
                <asp:TextBox ID="txtFromDate" runat="server" AutoPostBack="True" OnTextChanged="txtFromDate_TextChanged" Visible="False"></asp:TextBox>
